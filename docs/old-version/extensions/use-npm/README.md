...
```
Extensions/
		cn.apifox.ApifoxExtensions.SocketISO8538Unpacker/
				SocketISO8538Unpacker.js
```

在`cn.apifox.ApifoxExtensions.SocketISO8538Unpacker`目录下运行如下命令即可安装 `iso_8583` 包：
...
安装完成后，插件代码里直接`require('iso_8583')`即可使用：
...
下载地址：[https://www.lanzoux.com/SocketISO8538Unpacker](https://www.lanzoux.com/SocketISO8538Unpacker)
